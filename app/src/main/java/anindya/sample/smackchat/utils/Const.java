...
public class Const {
	...
	public static final String CHAT_SERVER_ADDRESS = "123.200.14.11";   // "153.126.152.115"; // you could replace with your local pc ip if mobile device is in same network
	public static final int CHAT_SERVER_PORT = 5222;
	public static final String CHAT_SERVER_SERVICE_NAME = "webhawksit";  // "153.126.152.115";
