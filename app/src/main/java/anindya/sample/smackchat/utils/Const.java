...
public class Const {
	...
	public static final String CHAT_SERVER_ADDRESS = "192.168.0.101"; //"123.200.14.11";   // "153.126.152.115"; // you could replace with your local pc ip if mobile device is in same network
